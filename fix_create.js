    ...
    <div style={{minHeight:'100vh',background:'#0a0a0a',padding:'60px 32px'}}>
      <div style={{maxWidth:'720px',margin:'0 auto'}}>
        ...
        <form onSubmit={handleSubmit} style={{display:'flex',flexDirection:'column',gap:'28px'}}>
          <div>
            <label style={{display:'block',color:'#555',fontSize:'12px',letterSpacing:'0.1em',textTransform:'uppercase',marginBottom:'10px'}}>
              Title
            </label>
            <input
              type='text'
          ...
          <div>
            ...
            />
            {imagePreview && (
              <img src={imagePreview} alt='Preview' style={{marginTop:'12px',height:'200px',width:'100%',objectFit:'cover',borderRadius:'6px',filter:'brightness(0.85)'}} />
            )}
          </div>
          ...
          <button
            type='submit'
            disabled={loading}
            style={{background:'#e8c547',color:'#0a0a0a',border:'none',borderRadius:'6px',padding:'16px',fontSize:'16px',fontWeight:'700',cursor:'pointer',letterSpacing:'0.04em',opacity:loading?0.7:1}}
          >
